...
type
  ...
  /// 数据主界面列
  /// </summary>
  TMainTreeColumns = (mtc_Mc = 0, mtc_Zy, mtc_Gclx, mtc_Price,
    mtc_Bz, mtc_AreaToken, mtc_FileToken);
  /// <summary>
  /// 节点移动类型
  /// </summary>
  TNodeMoveType = (nmt_IndexMoveUp, nmt_IndexMoveDown, nmt_MainMoveUp, nmt_MainMoveDown);
  /// <summary>
  /// 界面类别
  /// </summary>
  TTreeListType = (tlt_IndexTree, tlt_MainTree);
  /// <summary>
  /// 剪切板类型
  /// </summary>
  TClipboardType = (tct_Copy, tct_Cut);
