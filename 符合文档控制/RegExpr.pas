...
{$ENDIF}
 ...
 TRegExpr = class
   ...
   public
    ...
    // If true, then ?ÿ  additional include russian letter '?,
...
function RegPos (const ARegExpr, AInputStr : RegExprString) : integer;
...
{$ELSE}
 ...
 RusRangeHi = 'ÀÁÂÃÄÅ¨ÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞ?;
 RusRangeLoLow = '?;
 RusRangeLoHigh = 'ÿ';
 RusRangeHiLow = '?;
 RusRangeHiHigh = '?;
...
procedure TRegExpr.SetInputString (const AInputString : RegExprString);
 ...
 begin
  ...
  !! startp/endp âñ?ðàâí?áóäå?îïàñíî èñïîëüçîâàòü ?
  }
